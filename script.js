(function () {
  ...
  var TRANSLATIONS = {
    tr: {
      ...
      "proj.repo": "Repo →",
      "proj.descReefy": "Sakinleştirici bir akvaryum bakım ve koleksiyon oyunu: balıkları besle, tankı temizle, dekor topla. Saatlik kazanç, görevler ve arkadaş sistemiyle boş zaman katmanı.",
      "proj.descLGH": "Godot 4.7 ile geliştirilmiş, kesit görünümlü bir otel yönetim ve dekorasyon oyunu.",
      "proj.descCenge": "Klasik Türk usulü çengel bulmaca: 232 bulmaca, üç zorluk seviyesi, günlük bulmaca ve seri (streak) sistemi.",
      ...
      "writing.date4": "August 9, 2026",
      "writing.title4": "AI Security Is My Problem Now",
      "writing.title5": "MadMapper'da ilk 48 saat",
      "writing.date6": "18 Ağustos 2026",
      "writing.title6": "Dört büyük tehdit kategorisi: prompt injection, excessive agency, jailbreak, tedarik zinciri",
      "writing.filterAll": "Tümü",
      "writing.filterGameDev": "Game Dev Notes",
      "writing.filterAiSecurity": "AI Security",
      "writing.filterMapping": "Projection Mapping",
      "writing.catGameDev": "Game Dev Notes",
      "writing.catAiSecurity": "AI Security",
      "writing.catMapping": "Projection Mapping",
    ...
    en: {
      ...
      "proj.repo": "Repo →",
      "proj.descReefy": "A soothing aquarium care and collection game: feed your fish, clean the tank, collect decor. An idle layer with hourly earnings, quests, and friends.",
      "proj.descLGH": "A cross-section hotel management and decoration game built in Godot 4.7.",
      "proj.descCenge": "A classic Turkish-style crossword: 232 puzzles, three difficulties, a daily puzzle, and a streak system.",
      ...
      "writing.date4": "August 9, 2026",
      "writing.title4": "AI Security Is My Problem Now",
      "writing.title5": "First 48 hours in MadMapper",
      "writing.date6": "August 18, 2026",
      "writing.title6": "The four big threat categories: prompt injection, excessive agency, jailbreaks, supply chain",
